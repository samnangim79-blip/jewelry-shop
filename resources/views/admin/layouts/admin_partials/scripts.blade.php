...
<script src="{{ asset('assets/backend') }}/assets/js/jquery.min.js" data-navigate-once></script>
<!-- Bootstrap bundle JS -->
<script src="{{ asset('assets/backend') }}/assets/js/bootstrap.bundle.min.js" data-navigate-once></script>
<!-- plugins -->
<script src="{{ asset('assets/backend') }}/assets/plugins/simplebar/js/simplebar.min.js" data-navigate-once></script>
<script src="{{ asset('assets/backend') }}/assets/plugins/metismenu/js/metisMenu.min.js" data-navigate-once></script>
<script src="{{ asset('assets/backend') }}/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js" data-navigate-once></script>
<script src="{{ asset('assets/backend') }}/assets/js/pace.min.js" data-navigate-once></script>
<!-- app -->
<script src="{{ asset('assets/backend') }}/assets/js/app.js" data-navigate-once></script>
